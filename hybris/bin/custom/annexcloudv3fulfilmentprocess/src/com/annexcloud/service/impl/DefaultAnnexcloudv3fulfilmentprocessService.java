...
public class DefaultAnnexcloudv3fulfilmentprocessService implements Annexcloudv3fulfilmentprocessService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultAnnexcloudv3fulfilmentprocessService.class);
	...
	{
		return DefaultAnnexcloudv3fulfilmentprocessService.class.getResourceAsStream("/annexcloudv3fulfilmentprocess/sap-hybris-platform.png");
	}
