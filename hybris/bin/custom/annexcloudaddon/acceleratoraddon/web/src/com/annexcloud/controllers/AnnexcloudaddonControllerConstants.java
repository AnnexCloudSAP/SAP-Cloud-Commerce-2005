 ...
 */
package com.annexcloud.controllers;
...
/**
 */
public interface AnnexcloudaddonControllerConstants
{
	...
	interface Views
	{
		String ADDON_PREFIX = "addon:/annexcloudaddon/";
		...
		interface Pages
		{
			...
			{
				String AddPointRedemptionPage = ADDON_PREFIX + "pages/checkout/multi/acPointRedemptionPage";
