...
<%@ taglib prefix="spring" uri="http://www.springframework.org/tags" %>
	...
	<fmt:parseNumber var="pointsValue" integerOnly = "true" type = "number" value = "${product.pointsValue}" />
	...
	<ycommerce:testId code="product_wholeProduct">
		...
		<div class="details">
			...
			<ycommerce:testId code="product_productPrice">
				<div class="price"><product:productListerItemPrice product="${product}"/><br>
				<c:if test="${not empty product.pointsValue}">
						${ pointsValue} &nbsp;<spring:theme code="annex.point" />
			</c:if>
				</div>
			</ycommerce:testId>
