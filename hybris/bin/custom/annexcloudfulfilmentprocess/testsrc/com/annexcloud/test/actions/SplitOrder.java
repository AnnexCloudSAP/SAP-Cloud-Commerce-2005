 ...
 */
package com.annexcloud.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception
	{
		...
		warehouseCounter.setName(AnnexcloudfulfilmentprocessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(AnnexcloudfulfilmentprocessConstants.PARENT_PROCESS);
