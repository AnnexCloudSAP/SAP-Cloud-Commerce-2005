...
public class ProcessFlowTest extends HybrisJUnit4Test
{
	...
	public static void prepare() throws Exception
	{
		...
		xmlReader.loadBeanDefinitions(
				new ClassPathResource("/annexcloudfulfilmentprocess/test/process/consignment-process-spring.xml"));
		...
		definitonFactory.add("classpath:/annexcloudfulfilmentprocess/test/process/annexcloud-order-process.xml");
		definitonFactory.add("classpath:/annexcloudfulfilmentprocess/test/process/consignment-process.xml");
