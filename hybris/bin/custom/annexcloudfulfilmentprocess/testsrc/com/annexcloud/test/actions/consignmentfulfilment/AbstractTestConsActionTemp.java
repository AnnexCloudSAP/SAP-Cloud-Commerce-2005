 ...
 */
package com.annexcloud.test.actions.consignmentfulfilment;
...
public abstract class AbstractTestConsActionTemp extends TestActionTemp
{
	...
	{
		final String parentCode = (String) getProcessParameterValue(process, AnnexcloudfulfilmentprocessConstants.PARENT_PROCESS);
